...
/**
 * La clase EstudioEmpresa representa una empresa de manufactura que gestiona la producción
 * de diferentes componentes de hardware, los trabajadores asignados a cada tarea, y 
 * los costos operativos. Esta clase también maneja la interacción con una interfaz de usuario.
 * 
 */
public class EstudioEmpresa {
    ...
    /**
     * Inicializa los trabajadores y arranca los hilos correspondientes.
     * También crea instancias de ProjectManager y Director.
     */
    ...
    /**
     * Modifica el tipo de trabajo de los trabajadores que cumplen con un criterio específico.
     *
    ...
    /**
     * Calcula los costos totales acumulados de los salarios de los trabajadores.
     */
