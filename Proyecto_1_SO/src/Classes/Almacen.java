...
/**
 * La clase Almacen representa el almacén de una planta de fabricación de
 * computadoras. Se encarga de gestionar el inventario de componentes como
 * placas base, CPUs, RAM, fuentes de alimentación y tarjetas gráficas, así como
 * de contabilizar la producción de computadoras estándar y con tarjetas
...
public class Almacen {
     ...
     * Inicializa las cantidades de componentes y establece los máximos de
     * inventario.
     *
     * @param nombrePlanta Nombre de la planta (por ejemplo, "Dell" o "HP").
     * @param maxPlacaCantidad Máxima cantidad de placas base que puede
     * almacenar el almacén.
     * @param maxCpuCantidad Máxima cantidad de CPUs que puede almacenar el
     * almacén.
     * @param maxRamCantidad Máxima cantidad de RAM que puede almacenar el
     * almacén.
     * @param maxFuenteCantidad Máxima cantidad de fuentes de alimentación que
     * puede almacenar el almacén.
     * @param maxTarjetaCantidad Máxima cantidad de tarjetas gráficas que puede
     * almacenar el almacén.
    ...
    /**
     * Actualiza el inventario del almacén en función del tipo de trabajador y
     * su producción. Dependiendo del tipo de trabajador (ej. "Ensamblador",
     * "Placa Base", etc.), se ajustan las cantidades de componentes y se
     * actualizan las ganancias, costos y producción de computadoras.
     *
     * @param tipoTrabajador Tipo de trabajador que realiza la tarea (ej.
     * "Ensamblador", "Placa Base").
     * @param elementoFinalizado Número de elementos terminados por el
     * trabajador.
     * @param salario Salario del trabajador, que se suma al costo total de
     * producción.
     */
