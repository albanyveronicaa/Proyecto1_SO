 ...
 * Extiende la clase `Thread` para permitir la ejecución concurrente de tareas relacionadas con la gestión de proyectos.
 * Se encarga de gestionar el salario, la duración del proyecto y el control del estado de la planta, 
 * incluyendo la pausa y reanudación de actividades.
 */
public class ProjectManager extends Thread {
    ...
    /**
     * Acumula el pago diario del Project Manager.
     * Multiplica el salario por 24 (asumiendo pago por día).
     */
    public void pago() {
